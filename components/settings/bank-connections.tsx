...
import { Building2, Plus, Trash2, RefreshCw, CheckCircle2, Clock, AlertCircle, Loader2, X } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-text-muted">
        Connexion sécurisée en lecture seule via Tink (by Visa). Aucune action de paiement possible.
      </p>
    </div>
  )
}
